      ...
      <div className="border-b border-white/15 relative overflow-hidden">
        <div className="container mx-auto max-w-[1344px]">
          ...
          >
            ...
            >
              Don’t want to deal with technical stuff? Let us set up ShopNSwap for you, so you can focus on selling right away.
            </Paragraph>
        ...
        <div className="px-5 py-10 flex flex-col sm:px-10 lg:grid grid-cols-3 lg:gap-y-32">
          ...
          <div className="text-center lg:col-span-3 md:flex justify-between items-center">
            <div className="flex items-center justify-center gap-4 mb-4 order-2">
              <a href="https://www.instagram.com/shopnswap/" target="_blank" rel="noopener noreferrer">
                <img
              ...
              <a href="https://github.com/shopnswap" target="_blank" rel="noopener noreferrer">
                <img className="footer-icon" src="/github.svg" alt="github" />
              </a>
              <a href="https://t.me/shopnswap" target="_blank" rel="noopener noreferrer">
                <img
                  className="footer-icon"
                  src="/telegram.svg"
                  alt="telegram"
              ...
              <a href="https://www.linkedin.com/in/shopnswap/" target="_blank" rel="noopener noreferrer">
                <img
                  className="footer-icon"
                  src="/linkedin.svg"
                  alt="linkedin"
